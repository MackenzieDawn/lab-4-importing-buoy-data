...
buoy <- read_table("https://www.ndbc.noaa.gov/view_text_file.php?filename=46092h2025.txt.gz&dir=data/historical/stdmet/", comment = "#y")
...
buoy_clean <- clean_names(buoy, case = "snake")
...
write_csv(buoy_clean, file = "data_raw/buoy_update.csv")
...
buoy_update <- read_csv(
  file = ("data_raw/buoy_update.csv"),
...
buoy_final %>% 
  ggplot(aes(x = factor(mm), y = atmp, color = factor(mm))) +
  ...
  labs(
    ...
    caption = "Source: NOAA National Data Bouy Center",
    alt = "Monterey Bay Canyon Air Temperature in 2025 colored and separated by month") +
  theme_minimal() +
  guides(color = "none")
```
...
>The data I will be using and analyzing is sientific data collected from the MGL2506 cruise I took this summer during an internship (link not available).
Some questions I am looking at are: "How does nutrient concentration affect the size and complexity of microbial cells?" and "What is the distribution of the N:P ratio in the CCE?"
